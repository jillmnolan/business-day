...
export const isNewYear = (aMoment:any) => {
    var newYearsDay = moment('01-01-2021', 'MM-DD-YYYY').year(aMoment.year());
...
export const isEndOfYearNewYear = (aMoment:any) => {
    var newYearsDay = moment('01-01-2021', 'MM-DD-YYYY').year(aMoment.year() + 1);
...
export const isIndependenceDay = (aMoment:any) => {
    var independenceDay = moment('07-04-2021', 'MM-DD-YYYY').year(aMoment.year());
...
export const isLaborDay = (aMoment:any) => {
    var laborDay = moment('09-01-2021', 'MM-DD-YYYY').year(aMoment.year());
...
export const isMemorialDay = (aMoment:any) => {
    var memorialDay = moment('05-31-2021', 'MM-DD-YYYY').year(aMoment.year());
...
export const isMlkJrDay = (aMoment:any) => {
    var mlkJrDay = moment('01-01-2021', 'MM-DD-YYYY').year(aMoment.year()).add('14', 'days');
...
export const isThanksgivingDays = (aMoment:any) => {
    var thanksgivingDay = moment('11-22-2021', 'MM-DD-YYYY').year(aMoment.year());
    var dayAfterthanksgivingDay = moment('11-23-2021', 'MM-DD-YYYY').year(aMoment.year());
...
export const isVeteransDay = (aMoment:any) => {
    var veteransDay = moment('11-11-2021', 'MM-DD-YYYY').year(aMoment.year());
...
export const isChristmasDay = (aMoment:any) => {
    var christmasDay = moment('12-25-2021', 'MM-DD-YYYY').year(aMoment.year());
